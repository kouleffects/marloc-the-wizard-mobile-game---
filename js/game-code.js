		...
		class Asteroid
		{
			...
			*/
			constructor()
			{
				...
				this.explosionSound = createAudio("game-assets/Monster-Bat-Scream.wav");
				this.explosionImage = loadImage("game-assets/anime-explosion.png");
				this.load();
			}
		...
		class MissilePack
		{
			...
			constructor()
			{
				this.x = 0;
				this.y = 0;
				this.image = loadImage("game-assets/crystal-2.png");
				this.loadSound = createAudio("game-assets/magic-crystal-aquired-2.wav");
			}
		...
		class SpaceShip
		{
			...
			constructor()
			{
				this.image = loadImage("game-assets/marloc-2.png");
				this.engineSound = createAudio("game-assets/game-backround-sounds.wav");
				this.startSound = createAudio("game-assets/starting-voice.wav");
				this.endSound = createAudio("game-assets/ending-voice.wav");
			}
		...
		{	
			...
			*/
			constructor()
			{
				...
				{
					let live = loadImage("game-assets/lives.png");
					this.lives[i] = live;
				}
			}
		...
		*/
		function preload() 
		{
			background = loadImage("game-assets/pixel-cave-1.png");		// load the background-image
			asteroidImage = loadImage("game-assets/bat-pixel.png"); // load once and the pass to Asteroid so that will not load each time an Asteroid is created
			spaceship = new SpaceShip();
			
			missileImage = loadImage("game-assets/pixel-blue-flame-2.png");
		...
		function showMessages()
		{
			...
			text("Crystals: " + spaceship.missiles, 1120, 60); // Score is shown
			...
			{
				text('START(N)', 300, 300, 800, 200);
				textSize(25);
				text('Move the Wizard with the LEFT and RIGHT arrows', 340, 360, 800, 200);
				text('Launch Blue Flames with the F button', 340, 390, 800, 200);
			}
